$(document).ready(function(){
  ...
  "hardware":["Gameboy", "Playdate","Ink and Switch","Pebble watch","Digital pedometer","Old phone","Ancient Android device","Jailbroken iPhone","Homemade hardware device","Arduino", "Raspberry Pi", "XBox360", "Android", "Altair 8800", "Commodore 64", "hacked toaster", "Cyberdeck", "Apple Lisa", "computer running Windows 95","Thinkpad","Sega Jaguar","CCC Badge","Virtual Machine","TIS-100","Picotron Fantasy Hardware","Modular Synth","smartwatch","Flipper Zero","dumbphone","eink tablet","browser","the web","the net","web browser","fantasy console","MAME","arcade machine","Virtual Machine","quote unquote smark speakers","ipod touch","desktop","laptop","Linux","Unix systems"],
  "digitalArtifact":["game","application","program","software","simulator","sim","webgame","digital wizard","app","emulator","webapp", "tabletop RPG","encyclopedia", "open world game", "interactive game", "digitally-enhanced ebook", "hypertext fiction", "choose-your-own-adventure", "text adventure", "Flash-animated story", "interactive website", "Twine game","recipe book","ebook","DVD-Rom game from the 90s","wiki","interactive movie-game","productivity software","edutainment software","command line game","command line tool","debugger"],
